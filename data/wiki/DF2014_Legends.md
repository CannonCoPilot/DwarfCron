...
thumb|250px|right|Only two things are certain in *Dwarf Fortress*: [[Fun, and the legends you leave behind.]]
...
:Note: If you are already playing a fort or adventure on the save you want to use, you can make a copy of the existing world from the save folder, and then retire the fortress from that copy. <!-- or use dfhack method below-->

1. Available Information
thumb|In-game Legends viewer (*not to be confused with [[Utilities#Legends_Viewer| the utility of the same name*)]] 
...
- **Sites** - The number to the right indicates how many sites have existed throughout the world's history. Sites include things like towns, towers, fortresses, forest retreats, and caves.
...
1. (save name)-(year)-(month)-(day)-world_history.txt - Includes some information about the deities, and rulers of the Human, Dwarven, Elven, and Goblin civilizations. 
1. (save name)-(year)-(month)-(day)-world_sites_and_pops.txt  - Lists the sites' population, owner, parent civilization and warlord. This one will also list all the animal populations above and below ground including demons.
1. (save name)-(year)-(month)-(day)-world_map.bmp  - This is the full world map as it is shown on the embark screen, and, unlike the detailed maps below, will depend on the tileset and colour scheme you have installed.

1. Export Detailed Maps
...
- Elevations incl. lake and ocean floors
...
1. Legends viewing tools and visualisers
