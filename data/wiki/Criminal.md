...
Necromancers can also form bandit groups, headquartered in a tower.
...
1. Trivia
- If your reputation becomes exceptionally high ("Famous Hero", so above 75), bandits trying to ambush you will say "Ha-ha-halt!" instead of the normal announcement message, presumably stammering in front of such a fearsome figure. An exception is if they have .
thumb|220px|center|Bad to the Beard.*Art by Terry Colligan*
