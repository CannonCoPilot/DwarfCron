...
1. Modding Armies
thumb|right|A group of [[Elf|elves resting in a camp.]]
- Main article: Position token*

Every site can have its own army, and that army can potentially be sent out on missions.  The civ itself can also have its own army, which is treated as a separate army.  How armies are generated during world generation and activation depends on the noble positions.
