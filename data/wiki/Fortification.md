...
thumb|260px|right|Probably stopped a goblin siege once. Possibly.Fortifications can be built one of two ways. Firstly, they can be carved from constructed walls or smoothed natural walls by pressing  (engrave) and then  (fortification). The second way is through the construction menu: First press , then  followed by  (fortifications). As with most buildings, this will require one unit of wood, stone, metal, or glass. Note that constructed fortifications do *not* create walkable floors above them, while carved fortifications do.
