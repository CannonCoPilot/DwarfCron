...
100px|rightThis page was created to aid those looking to create new syndromes. Those familiar with syndrome design (and certain complexities in particular) should feel free to add helpful/obscure information to the lists below to help less-experienced members of the community with their syndromes.
...
1. Making a creature with a syndrome always applied
...
1. Creatures that behave differently underground
...
Note that the creature must have the  tag in order for the CAVE_ADAPT counter-trigger to work, and you will also need a constant secretion in order to ensure the syndrome is applied (see above).
