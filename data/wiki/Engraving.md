...
208px|thumb|right|A dwarf eating cheese
...
1. Effects on room value
thumb|right|The center area of the floor has been engraved. The left and bottom walls are also engraved, but the top one is not.How engravings affect room values has changed considerably, such that even the value of wall and floor tiles must first be understood.In a nutshell, however, in almost all cases it is now better to place walls/floors with high-value materials and then engrave those. It doesn't matter whether that placement is done using blocks, a rough boulder, or metal bars, as long as it is a Construction.
...
1. Make the lines of floor either side of this wall out of the most valuable material you can (aluminum or platinum are great; steel and gold also work), and have your best engraver engrave them
1. Place doors on top of all those engraved tiles, what sort doesn't really matter, as they will be adding 10-100 value to 2-3k value floor tiles
1. For every room add the doors and the wall(this is a convenient rectangle). The wall makes the doors shareable, and the doors make the engraved floor shareable.
For optimal results hide this to the south east of your area, otherwise the zone icons can get rather confused

1. Bugs 
- While the quality rating of engravings on ice walls is shown properly, the quality of engravings on ice *floors* doesn't show when looking at a tile with , only when hitting  to inspect the engraving. This gives the false impression that engraved ice floors have no quality levels. In addition, the engravings are described as "engraved on the wall" instead of "on the floor".
thumb|320px|center|Engraving of a Hindu civilization.
