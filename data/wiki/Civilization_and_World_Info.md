...
thumb|right|350px|An example screenshot of the Civilzation/World Info menu

The **Civilization/World Info menu** is your window to the world beyond your fortress. 

Accessed in Fortress mode with , it displays information pertaining to civilizations and their sites, provides access to news and rumors (shared by the Outpost liaison and by visitors), and lets you create and manage missions for your squads.

1. Submenus
thumb|150px|right|Full view of the Civilizations and World Info screen's map. The Civilization/World Info menu has six main submenus; orld, issions, ews and rumors, eople, rtifacts and ivilizations. It also has an overlay that can be toggled to display oldings and tribute (instead of geographical features).
thumb|150px|right|A world on the Holdings and Tribute tab

1. World
The World menu shows known information about the cursor's location on the map.

You can create a new mission to raid a highlighted site that doesn't belong to your civilization by pressing . This brings up the mission planning screen where you set the mission etails and assign squads to carry out the mission.

When one of your own holdings is highlighted, you can dispatch a messenger to equest specific citizens travel to your fortress. Note that a messenger must be assigned to your fortress from the ocations screen, similar to assigning someone the role of a performer or scholar. 

1. Holdings and Tribute
...
Your own holdings will be highlighted magenta. Holdings are acquired both by conquest and by economic success. You can send your own citizens away to inhabit your holdings (from the iew reference menu, hit ) and request workers to come from the holdings to your main fortress.
