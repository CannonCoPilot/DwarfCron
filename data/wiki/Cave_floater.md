...
If a cave floater is exposed to temperatures below 10000 °U (0 °C), such as by luring it out onto a glacier, it will die as a result of condensation. *(This is because cave floater gas, which constitutes the `[FUNCTIONAL]` tissue material of its `[THOUGHT]` body part, condenses at this temperature).*
...
thumb|center|310px|He who smelt it, died.*Crudely drawn by Zippy*
