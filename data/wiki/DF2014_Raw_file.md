...
- ITEM &mdash; items ranging from ammunition to food types, has secondary types for the purposes of [TYPE:ID].
    ...
    - ITEM_SIEGEAMMO &mdash; ammunition for siege weapons that ballistae fire.
