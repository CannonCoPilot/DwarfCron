...
center|Choose Fortress Location screen (v0.31.19)
...
Currently, an embark must be entirely within a tile on the "Region" view.  This restriction will be removed in the future.  The arrow keys control the X cursor in the center "Region" view while , , , and  move the embark location around within the Local view. , , , and  will resize the embark location.  
