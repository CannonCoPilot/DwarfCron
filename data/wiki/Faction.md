...
| style="background-color:#cfc"| Friendly1
| style="background-color:#cfc"| Friendly1
| style="background-color:#fcc"| Hostile1
...
| style="background-color:#fcc"| Hostile
| style="background-color:#fcc"| Hostile
| style="background-color:#fcc"| Hostile4
| style="background-color:#fcc"| Hostile
...
1. Attacking merchants from your mountainhome
...
1. Attempting to tame enemy mounts
...
1. Attacking a werebeast in dwarven form
...
1. Attacking a berserk citizen or werebeast in wereform
...
1. How to deal with loyalty cascades
...
1. DFHack
For those who are using DFHack, the command  can be used to immediately end most loyalty cascades.
